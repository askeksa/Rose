...
CFLAGS := -O3 -Iparser/rose -I../glfw-3.0.4.bin.WIN32/include -I../glew-1.10.0/include -Wno-write-strings -std=c++11
LFLAGS := ../glew-1.10.0/lib/Release/Win32/glew32s.lib -L../glfw-3.0.4.bin.WIN32/lib-mingw -lglfw3 -luser32 -lopengl32 -lgdi32 -static-libgcc -static-libstdc++ -s
