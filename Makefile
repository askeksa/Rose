...
LFLAGS := ../glew-1.10.0/lib/Release/Win32/glew32s.lib -L../glfw-3.0.4.bin.WIN32/lib-mingw ../portaudio/mingw32/usr/local/lib/libportaudio.lib -lglfw3 -lopengl32 -luser32 -lgdi32 -static-libgcc -static-libstdc++ -s
