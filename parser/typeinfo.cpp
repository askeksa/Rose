...
const rose::_TypeInfo rose::TDefy::type_info = {
    "TDefy",
    &Token::type_info,
    4,
    0,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTDefy
};
...
const rose::_TypeInfo rose::TJump::type_info = {
    "TJump",
    &Token::type_info,
    10,
    6,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTJump
};
...
const rose::_TypeInfo rose::TPlot::type_info = {
    "TPlot",
    &Token::type_info,
    13,
    9,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTPlot
};
...
const rose::_TypeInfo rose::TRand::type_info = {
    "TRand",
    &Token::type_info,
    15,
    11,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTRand
};
const rose::_TypeInfo rose::TSeed::type_info = {
    "TSeed",
    &Token::type_info,
    16,
    12,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTSeed
};
const rose::_TypeInfo rose::TSine::type_info = {
    "TSine",
    &Token::type_info,
    17,
    13,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTSine
};
...
const rose::_TypeInfo rose::TQuestion::type_info = {
    "TQuestion",
    &Token::type_info,
    40,
    36,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTQuestion
};
const rose::_TypeInfo rose::TColon::type_info = {
    "TColon",
    &Token::type_info,
    41,
    37,
    ...
    0,
    _TypeInfo::is_token,
    (_TypeInfo::apply_t)&Analysis::caseTColon
};
...
const rose::_TypeInfo rose::PProcMarker::type_info = {
    "PProcMarker",
    &Node::type_info,
    48,
    -1,
...
static int _type_elems_1[] = {1, 0, 1};
...
static int _type_elems_2[] = {};
const rose::_TypeInfo rose::AProcMarker::type_info = {
    "AProcMarker",
    &PProcMarker::type_info,
    57,
    -1,
    false,
    0,
    _type_elems_2,
    _TypeInfo::is_prod,
    (_TypeInfo::apply_t)&Analysis::caseAProcMarker
};
...
static int _type_elems_5[] = {0, 1, 1};
...
static int _type_elems_7[] = {0};
const rose::_TypeInfo rose::ADefyStatement::type_info = {
    "ADefyStatement",
    ...
    _type_elems_7,
    _TypeInfo::is_prod,
    (_TypeInfo::apply_t)&Analysis::caseADefyStatement
};
static int _type_elems_8[] = {0};
...
static int _type_elems_9[] = {0};
const rose::_TypeInfo rose::APlotStatement::type_info = {
    "APlotStatement",
    &PStatement::type_info,
    64,
    -1,
    ...
    _type_elems_9,
    _TypeInfo::is_prod,
    (_TypeInfo::apply_t)&Analysis::caseAPlotStatement
};
static int _type_elems_10[] = {0, 0, 1};
...
static int _type_elems_12[] = {0, 0, 0};
const rose::_TypeInfo rose::AJumpStatement::type_info = {
    "AJumpStatement",
    &PStatement::type_info,
    67,
    -1,
    ...
    _type_elems_12,
    _TypeInfo::is_prod,
    (_TypeInfo::apply_t)&Analysis::caseAJumpStatement
};
...
static int _type_elems_20[] = {0, 0, 1, 0, 1};
...
static int _type_elems_24[] = {0, 0, 0};
...
static int _type_elems_28[] = {0, 0, 0, 0};
const rose::_TypeInfo rose::ACondExpression::type_info = {
    "ACondExpression",
    &PExpression::type_info,
    83,
    -1,
    ...
    _type_elems_28,
    _TypeInfo::is_prod,
    (_TypeInfo::apply_t)&Analysis::caseACondExpression
};
